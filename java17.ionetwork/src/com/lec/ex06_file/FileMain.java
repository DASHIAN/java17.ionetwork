...
/*
 	파일입출력
 	file클래스
 	IO패키지에서 제공하는 File클래스는 파일크기, 속성, 이름 등으 ㅣ정보를 읽는 기능과 파일생성
 	삭제 등 관련 기능을 제공한다. 또한 디렉토리를 생성하고 디렉토리에 있는 파일목록을 읽는
 	기능도 제공한다.
 	
 	하지만, 파일의 데이터를 읽거나 쓰는 기능을 지원하지 않는다. 파일에 데이터를 입출력하고자
 	할 경우에는 File 입출력 스트림을 사용해야 한다.
